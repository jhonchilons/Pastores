...
class upload {
    ...
    function init() {
        ...
        $this->file_max_size = $this->__getsize($this->file_max_size_raw);
    ...
    function process($server_path = null) {
        ...
        $this->file_max_size = $this->__getsize($this->file_max_size);
        $this->jpeg_size = $this->__getsize($this->jpeg_size);
