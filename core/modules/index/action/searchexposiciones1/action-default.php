<?php 	
	...
	function getRecords($params) {
		...
		if( !empty($params['searchPhrase']) ) {   
			...
			$where .=" WHERE ";
			$where .=" (fechaexpo LIKE '%".$params['searchPhrase']."%' ";
			$where .=" OR nroexpo LIKE '%".$params['searchPhrase']."%' )";
		...
		//$sql = " SELECT * FROM vista_exposicionesciudadactivo ";
		$sql = " SELECT * FROM vista_exposicionesciudad ";
