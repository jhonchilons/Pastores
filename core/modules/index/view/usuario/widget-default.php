...
<div class="ibox float-e-margins">
	...
	<div class="ibox-title">
		...
		<div class="ibox-tools tooltip-demo">
			...
			<a href="index.php?view=usuario" data-toggle="tooltip" data-placement="top" title="Refrescar"><i class="glyphicon glyphicon-repeat"></i></a> 
	...
	<div class="table-responsive">
		...
		<table class="table table-striped table-bordered table-hover" id="dato_grid" cellspacing="0" data-toggle="bootgrid">
			...
			<th align="center" data-column-id="name">Nombres</th>
			<th align="center" data-column-id="lastname">Apellidos</th>
			<th align="center" data-column-id="username">Usuario</th>
			<th data-column-id="is_active" data-formatter="is_active">Activo</th>
			</tr>
			</thead>
		...
		$( document ).ready(function() {
			...
			var grid = $("#dato_grid").bootgrid({
				...
				url: "index.php?action=searchusuario",
				...
				formatters: {
						...
						"commands": function(column, row)
						{
							return "<button type=\"button\" class=\"btn btn-xs btn-warning command-edit\" data-row-id=\"" + row.id + "\"><span class=\"glyphicon glyphicon-edit\"></span></button> " + 
								"<button data-toggle=\"modal\" data-target=\"#modal-form-delete\" type=\"button\" class=\"btn btn-xs btn-dark command-delete\" data-row-id=\"" + row.id + "\"><span class=\"glyphicon glyphicon-trash\"></span></button> ";
						}, 
...

		{
			...
			grid.find(".command-edit").on("click", function(e)
			{
				...
				location.href="index.php?view=editusuario&id="+conf;
		...
		<div class="modal inmodal" id="modal-form-delete" tabindex="-1" role="dialog" aria-hidden="true">
			...
			<div class="modal-dialog">
				<form method="post" role="form" action="index.php?view=delusuario">
