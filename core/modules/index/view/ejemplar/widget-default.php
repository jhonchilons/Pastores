...
<div class="ibox float-e-margins">
	...
	<div class="ibox-title">
		...
		<div class="ibox-tools tooltip-demo">
			...
			<a href="index.php?view=ejemplar" data-toggle="tooltip" data-placement="top" title="Refrescar"><i class="glyphicon glyphicon-repeat"></i></a> 
	...
	<div class="table-responsive">
		...
		<table class="table table-striped table-bordered table-hover" id="dato_grid" cellspacing="0" data-toggle="bootgrid">
			<thead>
			<tr> 
				<th align="center" data-column-id="nombredog">Nombre Dog</th>
				<th align="center" data-column-id="sexo">Sexo</th>  
				<th align="center" data-column-id="fechanac">Fecha Nac</th>  
				<th align="center" data-column-id="padre">Padre</th>  
				<th align="center" data-column-id="madre">Madre</th>   
				<th align="center" data-column-id="criador">Criador</th>  
		...
		$( document ).ready(function() {
			var grid = $("#dato_grid").bootgrid({
				...
				url: "index.php?action=searchejemplar",
				formatters: {
						"commands": function(column, row)
						{
							return "<button type=\"button\" class=\"btn btn-xs btn-warning command-edit\" data-row-id=\"" + row.idejemplar + "\"><span class=\"glyphicon glyphicon-edit\"></span></button> " + 
								"<button data-toggle=\"modal\" data-target=\"#modal-form-delete\" type=\"button\" class=\"btn btn-xs btn-dark command-delete\" data-row-id=\"" + row.idejemplar + "\"><span class=\"glyphicon glyphicon-trash\"></span></button> ";
						} 
					}
...

		{
			...
			grid.find(".command-edit").on("click", function(e)
			{
				...
				location.href="index.php?view=editejemplar&id="+conf;
		...
		<div class="modal inmodal" id="modal-form-delete" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<form method="post" role="form" action="index.php?view=delejemplar">
				<div class="modal-content animated flipInY">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<h4 class="modal-title">Borrar Pedigree</h4>
	...
	<div class="ibox-content">
				<form id="form" method="post" class="form-horizontal" action="fpdf/vistaejemplares.php" enctype="multipart/form-data" >
					<div class="form-group row">
						<label class="col-sm-4 control-label font-bold"></label>
						<div class="col-sm-4 col-sm-offset-2"> 
							<input type="hidden" id="idxxxx" name="idxxx">
							<button class="btn btn-primary btn-sm" type="submit"> Ver vista de Impresión</button>
						</div>
					</div>
				</form>
			</div> 
