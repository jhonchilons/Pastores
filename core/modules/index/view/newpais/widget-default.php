...
<div class="row wrapper border-bottom blue-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb blue-bg">
			...
			<li class="breadcrumb-item"><a href="index.php?view=pais">Paises</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><i class="fa fa-plus-circle"></i> Registro de Paises</h5>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="ibox-content">
                            <form id="form" method="post" class="form-horizontal" action="index.php?view=addpais" enctype="multipart/form-data" >
                               
                                <div class="hr-line-dashed"></div>
                                
                                <div class="form-group row">
                                    <label for="inputEmail1" class="col-md-1 control-label font-bold"><i class="fa fa-slack"></i> Pais</label>
                                    <div class="col-md-3">
                                    <input required type="text" name="nombrepais" required class="form-control" id="nombrepais" placeholder="Ingrese Pais" require onkeyup="mayus(this);">
                                    </div>
                                </div> 
