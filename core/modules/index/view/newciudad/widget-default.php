...
if($GLOBALS["u"]->is_admin >= 0){ 
    $inscripciones   = CiudadData::getAll();
?>

<div class="row wrapper border-bottom blue-bg page-heading">
	<div class="col-lg-10">
		<h2>Registro de Ciudades del Peru</h2>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><i class="fa fa-plus-circle"></i> Registro de Ciudades</h5>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="ibox-content">
                            <form id="form" method="post" class="form-horizontal" action="index.php?view=addciudad" enctype="multipart/form-data" >
                               
                                <div class="hr-line-dashed"></div>
                                
                                <div class="form-group row">
                                    <label for="inputEmail1" class="col-md-2 control-label font-bold"><i class="fa fa-slack"></i> Ciudad</label>
                                    <div class="col-md-2">
                                    <input required type="text" name="ciudad" required class="form-control" id="ciudad" placeholder="Ingrese Ciudad" require>
                                    </div>
                                </div> 
