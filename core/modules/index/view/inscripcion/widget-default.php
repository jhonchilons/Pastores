...
<div class="row wrapper border-bottom white-bg page-heading">
	...
	<div class="col-lg-10">
		<h2>INSCRIPCIONES DE EJEMPLARES</h2>
		<ol class="breadcrumb">
...
<div class="ibox float-e-margins">
	<div class="ibox-title">
		...
		<h5><i class="fa fa-th-list"></i> Listado de Exposciones Activas</h5>
	...
	<div class="table-responsive">
		...
		$( document ).ready(function() {
			var grid = $("#dato_grid").bootgrid({
				...
				url: "index.php?action=searchinscripcion",
				formatters: {
...

		{
			...
			grid.find(".command-edit").on("click", function(e)
			{
				...
				location.href="index.php?view=editinscripcion&id="+conf;
