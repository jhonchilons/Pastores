...
<div class="row wrapper border-bottom white-bg page-heading">
	...
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li  class="breadcrumb-item active"><strong>Paises</strong></li>
		</ol>
    </div>
    <div class="col-lg-2">
    </div>
...
<div class="ibox float-e-margins">
	<div class="ibox-title">
		...
		<h5><i class="fa fa-th-list"></i> Listado de Paises</h5>
		...
		<div class="ibox-tools tooltip-demo">
			...
			<a href="index.php?view=pais" data-toggle="tooltip" data-placement="top" title="Refrescar"><i class="glyphicon glyphicon-repeat"></i></a> 
	...
	<div class="table-responsive">
		...
		<table class="table table-striped table-bordered table-hover" id="dato_grid" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
			<tr> 
				<th align="center" data-column-id="idpais">Codigo Pais</th>
				<th align="center" data-column-id="nombrepais">Nombre de Pais</th>
		...
		$( document ).ready(function() {
			var grid = $("#dato_grid").bootgrid({
				...
				url: "index.php?action=searchpaises",
				formatters: {
						"commands": function(column, row)
						{
							return "<button type=\"button\" class=\"btn btn-xs btn-warning command-edit\" data-row-id=\"" + row.idpais + "\"><span class=\"glyphicon glyphicon-edit\"></span></button> " + 
								"<button data-toggle=\"modal\" data-target=\"#modal-form-delete\" type=\"button\" class=\"btn btn-xs btn-dark command-delete\" data-row-id=\"" + row.idpais + "\"><span class=\"glyphicon glyphicon-trash\"></span></button> ";
						} 
					}
...

		{
			...
			grid.find(".command-edit").on("click", function(e)
			{
				...
				location.href="index.php?view=editpais&id="+conf;
		...
		<div class="modal inmodal" id="modal-form-delete" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<form method="post" role="form" action="index.php?view=delpais">
				<div class="modal-content animated flipInY">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<h4 class="modal-title">Borrar Pais</h4>
