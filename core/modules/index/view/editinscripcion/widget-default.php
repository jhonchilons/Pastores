...
if($GLOBALS["u"]->is_admin > 0){ 
    $inscripciones   = InscripcionData::getByExpoEjem($_REQUEST['idExpo'], $_REQUEST['idEjem']);
                        ...
                        <div class="ibox-content">
                            <form id="form" method="post" class="form-horizontal" action="index.php?view=updateinscripcion" enctype="multipart/form-data" >
                                ...
                                <label class="col-lg-2 control-label font-bold"><i class="fa fa-slack"></i> Fecha de Inscripción</label> 
                                    <div class="col-sm-2">
                                        <input type="text" name="fechareg" class="form-control" value= "<?php echo $inscripciones->fechareg;?>" readonly> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">  
                                            <select data-placeholder="Buscar..." class="chosen-select"  tabindex="1" name="idexposicion"> 
                                                <option value="0" >SELECCIONA EXPOSICION...</option>
                                                <?php foreach($exposiciones as $exposicion):?>
                                                    <option value="<?php echo $exposicion->idexposicion ?>" 
                                                    <?php if($inscripciones->idexposicion==$exposicion->idexposicion) echo "selected"; ?>>
                                                    <?php echo htmlspecialchars($exposicion->nroexpo.' - '.$exposicion->ciudad) ?></option>
                                                <?php endforeach;?>
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-sm-4"> 
                                        <select data-placeholder="Buscar..." class="chosen-select"  tabindex="1" name="idejemplar"> 
                                            <option value="0" >SELECCIONA EJEMPLAR...</option>
                                            <?php foreach($ejemplares as $ejemplar):?>
                                                <option value="<?php echo $ejemplar->idejemplar ?>" 
                                                <?php if($inscripciones->idejemplar==$ejemplar->idejemplar) echo "selected"; ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="i-checks">
                                            <label> <input type="radio" value="NORMAL" name="tipoins" <?php if($inscripciones->tipoins=='NORMAL') echo "checked";?>> NORMAL </label>&nbsp; &nbsp; 
                                            <label> <input type="radio" value="FUERA CATA" name="tipoins" <?php if($inscripciones->tipoins=='FUERA CATA') echo "checked";?>> FUERA CATALOGO </label> 
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                    <input required type="text" name="contacto" required class="form-control" id="contacto" placeholder="Nombre y Apellido" require onkeyup="mayus(this);" value="<?php echo htmlspecialchars($inscripciones->contacto) ?>">
                                    </div>

                                    <label for="inputEmail1" class="col-md-2 control-label font-bold"><i class="fa fa-slack"></i> Correo</label>
                                    <div class="col-md-2">
                                    <input required type="email" name="correo" required class="form-control" id="correo" placeholder="ejemplo@gmail.com" require value="<?php echo htmlspecialchars($inscripciones->correo) ?>">
                                    </div>

                                    <label for="inputEmail1" class="col-md-2 control-label font-bold"><i class="fa fa-slack"></i> Telefono</label>
                                    <div class="col-md-2">
                                    <input required type="number" name="celular" required class="form-control" id="celular" placeholder="Ingrese nro de celular" require maxlength = "14" value="<?php echo htmlspecialchars($inscripciones->celular) ?>">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2"> 
                                        <button class="btn btn-primary btn-sm" type="submit"> Actualizar Registro</button>
                                    </div>
                                </div>
