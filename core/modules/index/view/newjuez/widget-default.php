...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"><strong>Nuevo Juez</strong></li>
		</ol>
    </div>
</div>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools tooltip-demo">
								...
								<a href="index.php?view=newjuez" data-toggle="tooltip" data-placement="top" title="Refrescar"><i class="glyphicon glyphicon-repeat"></i></a> 
								<a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </div>
                        </div>

                        <div class="ibox-content">
                            <form id="form" method="post" class="form-horizontal" action="index.php?view=addjuez" enctype="multipart/form-data"> 
                                <div class="form-group row">
                                    <label for="nroexpo" class="col-lg-2 control-label font-bold"><i class="fa fa-slack"></i> Nrombre del Juez (*)</label>
                                    <div class="col-md-6">
                                        <input  type="text" name="nombrejuez" required class="form-control" id="nombrejuez" placeholder="Nombre Juez" required onkeyup="mayus(this);">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input required type="text" name="titulo" required class="form-control" id="titulo" placeholder="Juez: APPPA-COAPA-SV" onkeyup="mayus(this);">
                                    </div>
                                </div> 
